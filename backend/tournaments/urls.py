...
urlpatterns = [
    ...
    path('manage/', TournamentCreateUpdateView.as_view(), name='tournament_manage_create'),
    path('manage/<int:pk>/', TournamentCreateUpdateView.as_view(), name='tournament_manage_update'),
