      ...
      <div class="global-setting">
        <label class="setting-row">
          <div class="setting-info">
            ...
            <span class="setting-desc">You will not receive any emails from the system if checked.</span>
          </div>
          <ui-switch 
...
import { useNotificationSettings, useUpdateEventConfig, useUpdateGlobalConfig } from '@/queries/notifications'
...
const handleEventToggle = (eventType: string, channel: 'system' | 'email', val: boolean) => {
  ...
  updateEvent(payload, {
    onSuccess: () => showNotification(`Settings for ${getEventTitle(eventType)} updated`, 'success'),
